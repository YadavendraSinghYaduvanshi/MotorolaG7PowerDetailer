...
public class RearSpotColorFragment extends Fragment implements View.OnClickListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view =  inflater.inflate(R.layout.fragment_rear_spot_color, container, false);
        decalartion(view);
    ...
    private void selectSets(int set){
        switch (set){
            case set1:
                setCurrentMode(set1,R.drawable.rear_normal_spot_color_img_set1,R.drawable.rear_spot_color_img_set1,0,set2,false,true);
                break;

            case set2:
                setCurrentMode(set2,R.drawable.rear_normal_spot_color_img_set2,R.drawable.rear_spot_color_img_set2,set1,0,true,false);
                break;
