...
public class RearHighResultionCameraFragment extends Fragment implements View.OnClickListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view =  inflater.inflate(R.layout.fragment_rear_high_resultion_camera, container, false);
        decalartion(view);
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.btn_normal:
                // do your code
                btnHighResolutionImg.setImageResource(R.drawable.btn_high_resolution_white);
            ...
            case R.id.btn_high_resolution:
                // do your code
                btnHighResolutionImg.setImageResource(R.drawable.btn_high_resolution_green);
    ...
    private void selectSets(int set){
        switch (set){
            case set1:
                setCurrentMode(set1,R.drawable.rear_high_res_normal_set1,R.drawable.rear_high_res_set1,0,set2,false,true);
                break;

            case set2:
                setCurrentMode(set2,R.drawable.rear_high_res_normal_set2,R.drawable.rear_high_res_set2,set1,set3,true,true);
                break;

            case set3:
                setCurrentMode(set3,R.drawable.rear_high_res_normal_set3,R.drawable.rear_high_res_set3,set2,0,true,false);
                break;
